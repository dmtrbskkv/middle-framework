...
final class EscaperNodeVisitor implements NodeVisitorInterface
{
    ...
    public function enterNode(Node $node, Environment $env): Node
    {
        if ($node instanceof ModuleNode) {
            if ($env->hasExtension(EscaperExtension::class)
                && $defaultStrategy = $env->getExtension(EscaperExtension::class)->getDefaultStrategy(
    ...
    private function unwrapConditional(
    ...
    private function getEscaperFilter(string $type, Node $node): FilterExpression
    {
        ...
        $args = new Node(
            [
                new ConstantExpression($type, $line),
