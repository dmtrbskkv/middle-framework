    ...
    public function checkMethodAllowed($obj, $method): void
    {
        ...
        if (!$allowed) {
            ...
            throw new SecurityNotAllowedMethodError(
                sprintf('Calling "%s" method on a "%s" object is not allowed.', $method, $class), $class, $method
            );
        }
    }
    ...
    public function checkPropertyAllowed($obj, $property): void
    {
        ...
        if (!$allowed) {
            ...
            throw new SecurityNotAllowedPropertyError(
                sprintf('Calling "%s" property on a "%s" object is not allowed.', $property, $class), $class, $property
            );
        }
    }
}
